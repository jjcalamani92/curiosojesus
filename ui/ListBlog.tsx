...
export default function ListBlog({ page }: Props) {
  const {data:{name, description}, articles} = page
  return (
      ...
      <div className="lg:w-3/4 xl:w-2/4 lg:mx-auto">
          {articles?.map((article, i) => (
            ...
            <div className="sm:p-2 sm:pl-0 sm:w-4/6">
              ...
              <br/>
              <Link href={`/blog/content/${article?.slug}`} className="text-2xl font-semibold text-gray-800 dark:text-white">
               {article.data.name}
              </Link>
